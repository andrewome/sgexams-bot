export abstract class CommandNamesAndDescriptions {
  ...
  public static readonly BIRTHDAY_HELP_COMMAND_NAME = 'BirthdayHelp';

  public static readonly BIRTHDAY_HELP_COMMAND_DESCRIPTION
      = 'Displays other Birthday commands';
  ...
  public static readonly HELP_COMMANDS = [
      ...
      CommandNamesAndDescriptions.BIRTHDAY_HELP_COMMAND_NAME,
  ];
  ...
  public static readonly HELP_DESCRIPTIONS = [
      ...
      CommandNamesAndDescriptions.BIRTHDAY_HELP_COMMAND_DESCRIPTION,
  ];
  ...
  /** Birthday commands */
  public static readonly SET_BIRTHDAY_COMMAND_NAME = 'SetBirthday';

  public static readonly SET_BIRTHDAY_COMMAND_DESCRIPTION
      = 'Sets your birthday announcement to the specified date.';

  public static readonly SET_BIRTHDAY_CHANNEL_COMMAND_NAME = 'SetBirthdayChannel';

  public static readonly SET_BIRTHDAY_CHANNEL_COMMAND_DESCRIPTION
      = 'Assigns the given channel as the birthday announcements channel.';

  public static readonly LIST_BIRTHDAYS_COMMAND_NAME = 'ListBirthdays';

  public static readonly LIST_BIRTHDAYS_COMMAND_DESCRIPTION
      = 'Lists users with the given birthday.'

  public static readonly BIRTHDAY_COMMANDS = [
      CommandNamesAndDescriptions.SET_BIRTHDAY_COMMAND_NAME,
      CommandNamesAndDescriptions.SET_BIRTHDAY_CHANNEL_COMMAND_NAME,
      CommandNamesAndDescriptions.LIST_BIRTHDAYS_COMMAND_NAME,
  ];

  public static readonly BIRTHDAY_DESCRIPTIONS = [
      CommandNamesAndDescriptions.SET_BIRTHDAY_COMMAND_DESCRIPTION,
      CommandNamesAndDescriptions.SET_BIRTHDAY_CHANNEL_COMMAND_DESCRIPTION,
      CommandNamesAndDescriptions.LIST_BIRTHDAYS_COMMAND_DESCRIPTION,
  ];

  public static readonly BIRTHDAY_COMMANDS_LOWERCASE
      = CommandNamesAndDescriptions.BIRTHDAY_COMMANDS.map((x) => x.toLowerCase());
}
